...
const AboutPage = () => (
    <Layout>
        ...
        <div className="row">
            <h3>Our Faculty Advisors</h3>
            <div className="column2">
                <div style={{ maxWidth: `100%` }}>
                    <Image alt="Faculty Advisor1" filename="FacultyAdvisor1.jpg" />
                </div>
            </div>
            <div className="column2">
                <h3>Gene McGinnis</h3>
        ...
        <div className="row">
            <div className="column2">
                <div style={{ maxWidth: `100%` }}>
                    <Image alt="Faculty Advisor2" filename="FacultyAdvisor2.jpg" />
                </div>
            </div>
            <div className="column2">
                <h3>Michael June</h3>
                <p>
                Professor Michael Sean June is an Associate Professor of Mechanical Engineering.
                Dr. June is also the BSEM Sustainability Concentration Coordinator. 
                He graduated from North Carolina State University with a PhD in Mechanical Engineering. 
                </p>
                <p>
                <b>Phone:</b> (901) 321-3409
                <br></br>
                <b>E-mail:</b> <a href="mailto:mjune@cbu.edu">mjune@cbu.edu</a>
                <br></br>
                <b>Office:</b> Nolan 111
                </p>
            </div>
        </div>
